...
\chapter{Bevezetés}
\label{bev}
\input{parts/bevezetes.tex}

%2. fejezet
\chapter{Veszprém tömegközlekedése}
\label{tom}
\input{parts/hasonlofejl.tex}

%3. fejezet
\chapter{Követelmények, technológiák}
\label{kov}
\input{parts/kovetelmeny.tex}

%4. fejezet
\chapter{Felhasználói kézikönyv}
\label{felhaszn}
\input{parts/felhasznaloi.tex}

%5. fejezet
\chapter{Fejlesztői dokumentáció}
\label{fejl}
\input{parts/fejlesztoi.tex}

%6. fejezet
\chapter{Továbbfejlesztési lehetőségek}
\label{tovabbfejl}
\input{parts/tovabbfejl.tex}

%7. fejezet
\chapter{Összefoglalás}
\label{osszefogl}
\input{parts/osszefoglalas.tex}
