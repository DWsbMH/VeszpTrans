...
\Picture{Élő útvonalinformáció}{2/elojaratinfo}{width=5cm, height=8cm}
...
\Picture{Veszprém tömegközlekedési hálózata\cite{kozlekedesihalozat}}{2/veszprembuszhalozat}{width=14cm}
...
\Picture{Az 1-es és a 4-es járat útvonala}{2/kirajzoltjarat}{width=14cm}
...
Ezt követően az oldal kilistázza nekünk azokat a buszokat és a hozzájuk tartozó indulási időket, amikkel eljuthatunk a célunkhoz \aref{fig_2/bambuszvpmenetrend}.\ ábra a) részén látható módon. 
Hátránya hasonlóan a hivatalos oldalhoz, hogy ismernünk kell a megállókat, ahhoz hogy használni tudjuk. 

\Picture{Az alkalmazások főképernyője}{2/bambuszvpmenetrend}{width=14cm, height=8cm}

\subsection{Veszprémi buszmenetrend}
\label{veszprbuszmen}

Okostelefonra elérhető alkalmazás\cite{veszprembusz}, ami letisztultan, egyszerűen és gyorsan jeleníti meg a buszjáratokat külön menüpontba szedve, ahogy \aref{fig_2/bambuszvpmenetrend}.\ ábra b) képén látható. 
