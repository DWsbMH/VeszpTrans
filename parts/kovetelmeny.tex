...
Cél volt továbbá, hogy a rendszer másik szereplői, az adminisztrátorok számára is könnyen kezelhető, felhasználóbarát felület valósuljon meg. %Szeretsz mondatokat Tovabba-val kezdeni :-) Annyira nem jo ;-)
\todo{ABRA}.\ képen láthatóak a rendszer szereplői és a hozzájuk tartozó használati esetek. 
...
\begin{itemize}
	...
	Megjelenésénél figyelni kellett arra, hogy felülete letisztult legyen, mégis a keresett információ könnyen megtalálható legyen. %legyen-legyen	
	\item \textbf{Megállók}
	\\
...
Futtatási sebessége a Java-hoz képes javult, hiszen a kibővített Java programozási nyelvet Android esetén egy olyan virtuális gépen futtatják, amely szerves részét képezi az Android operációs rendszernek. % Ez az a resz, ahol hivatkozasokkal tele kell tomni a dolgozatot.
...
Az általam választott nyelv a twig, amellyel a megjelenítés elválasztható az üzleti logikától. %Ez tok jo, de az nem lett leirva, hogy a Symfony egy php alapu backend engine :-D
